...
Rumina 现在包含 JIT (Just-In-Time) 编译器，可以自动优化热点代码路径：

- **自动热点检测**：自动识别并优化频繁执行的代码
- **超指令优化**：将多条指令合并为单条优化指令
- **整数快速路径**：整数运算的特殊优化路径
- **性能提升**：循环和算术密集型代码可获得 1.5-3x 的性能提升

详见 [JIT 优化文档](docs/JIT_OPTIMIZATION.md)
